<template>
    <div class="container-fluid d-flex justify-content-center align-items-center vh-100">
        <div class="card p-4 shadow-lg bg-body rounded border-0">
            ...
            <small class="card-title text-center">Silakan Login terlebih dahulu</small>
            ...
            <div class="modal fade" ref="errorModal" tabindex="-1" role="dialog" aria-labelledby="errorModalLabel"
                aria-hidden="true">
            ...
            <!-- Add a new Bootstrap modal for login success -->
            <div class="modal fade" ref="successModal" tabindex="-1" role="dialog" aria-labelledby="successModalLabel"
                aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
...
export default {
    ...
    methods: {
        ...
        closeModal() {
            ...
            this.$refs.errorModal.classList.remove('show'); // Add this line
